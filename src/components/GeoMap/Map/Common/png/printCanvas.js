...
function layoutSetting() {
    ...
    var differ_x_extent =
        (differ_width_val * scale) / 1000 / 1000 / extent_km; //毫米 换算成 度
    var differ_y_extent =
        (differ_height_val * scale) / 1000 / 1000 / extent_km; //毫米 换算成 度
    //版面的左上角x坐标
...
export function printCanvas(map, layout) {
    if (!map) return;
    ...
    console.log("layextent", layExtent);
