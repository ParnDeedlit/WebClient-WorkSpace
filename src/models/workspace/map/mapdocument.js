export default {
  ...
  state: {
    background:{
      ...
      name:"MapBox浅色背景",
      id:"mapboxlight",
      tileUrl:"https://api.tiles.mapbox.com/v4/mapbox.light/{z}/{x}/{y}.png?access_token=sk.eyJ1IjoiY2hlbmdkYWRhIiwiYSI6ImNqZDFjaGo0ZjFzcnoyeG54enoxdnNuZHUifQ.hTWXXBUQ0wdGeuDF3GWeUw",
      imgUrl:
    ...
    layers: [{
      ...
      style: "http://localhost:6163/igs/rest/mrms/vtiles/styles/vectortile.json",
      name:"矢量瓦片-地类图斑",
      id:"hunan"
    }]
  },
  reducers: {
    changeBackgroud(state, { payload: background }){
      var newState = { ...state, background };
      return newState;
    },
