import createMapboxStreetsV6Style from './MapboxStreetsV6Style'
import createMapgisVectorTileStyle from './MapgisVectorTileStyle'
...
export default function VectorTileProvider(Cesium, ol, options) {
